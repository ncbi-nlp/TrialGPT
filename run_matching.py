...
"""
Running the TrialGPT matching for three cohorts (sigir, 2021, 2022).
"""
...
if __name__ == "__main__":
	...
	output_path = f"results/trial_{split}_{model}_matching_results.json"
	...
	for instance in dataset:
		...
		for label in ["0", "1", "2"]:
			# meaning that this patient doesn't have this label in the ground-truth (i.e., SIGIR's 1)
